  ...
  return (
    ...
    <header>
        ...
        <div className={"header-content"}>
            <h1>Strategise your business with technology</h1>
    ...
    <main>
        ...
        <section className={'us'}>
            ...
            <i class="fa-solid fa-tv"></i>
            <h1>Passionate</h1>
            <p>We passionately and creatively infuse every facet of our service, transforming your dreams into extraordinary reality.</p>
            </div>
            <div className={'about-content'}>
            <i class="fa-solid fa-laptop"></i>
            <h1>Professional</h1>
            <p>We provide our services with the highest professionalism, guaranteeing exacting attention to detail and faultless execution. Excellence is our benchmark.</p>
            </div>
            <div className={'about-content'}>
            <i class="fa-solid fa-globe"></i>
            <h1>Support</h1>
            <p>Beyond the sale, we are dedicated to providing you with reliable after-sales service to ensure your ongoing success and happiness.</p>
            </div>
        </section>
